...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './cartoes.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CARTOES_LIST actions', async () => {
    ...
    it('dispatches FETCH_CARTOES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CARTOES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CARTOES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CARTOES actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CARTOES actions', async () => {
      const expectedActions = [
        {
