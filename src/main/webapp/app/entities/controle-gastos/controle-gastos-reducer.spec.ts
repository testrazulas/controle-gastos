...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_CONTROLEGASTOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_CONTROLEGASTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_CONTROLEGASTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_CONTROLEGASTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_CONTROLEGASTOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_CONTROLEGASTOS actions', async () => {
      const expectedActions = [
        {
