...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './despesas.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_DESPESAS_LIST actions', async () => {
    ...
    it('dispatches FETCH_DESPESAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_DESPESAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_DESPESAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_DESPESAS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_DESPESAS actions', async () => {
      const expectedActions = [
        {
