...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './salarios.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_SALARIOS_LIST actions', async () => {
    ...
    it('dispatches FETCH_SALARIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_SALARIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_SALARIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_SALARIOS actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_SALARIOS actions', async () => {
      const expectedActions = [
        {
